        ...
        if (cleanSql.includes("FROM users u") && cleanSql.includes("WHERE u.role = 'student'")) {
            ...
            let combined = (users || []).map(u => {
                ...
                return {
                    ...
                    diploma_percentage: sp.diploma_percentage,
                    degree: sp.degree || "B.Tech",
                    sem1_gpa: sp.sem1_gpa,
                    sem2_gpa: sp.sem2_gpa,
                    sem3_gpa: sp.sem3_gpa,
                    sem4_gpa: sp.sem4_gpa,
                    sem5_gpa: sp.sem5_gpa,
                    sem6_gpa: sp.sem6_gpa,
                    sem7_gpa: sp.sem7_gpa,
                    sem8_gpa: sp.sem8_gpa,
                    dob: sp.dob,
                    personal_email: sp.personal_email,
                    college_email: sp.college_email || u.email,
